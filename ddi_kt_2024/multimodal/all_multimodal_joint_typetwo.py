...
class BertForSequenceClassification(BertPreTrainedModel):
    def __init__(self,
        ...
        if kwargs['use_graph']:
            ...
            self.graph_classifier_represent = nn.Linear(self.gnn.hidden_channels*2, self.represent_dim[0])
            self.norm_graph = torch.nn.BatchNorm1d(self.represent_dim[0])
        ...
        if kwargs['use_formula']:
            ...
            self.formula_classifier_represent = nn.Linear(self.formula_conv_output_size*2, self.represent_dim[1])
            self.norm_formula = torch.nn.BatchNorm1d(num_features=self.represent_dim[1])
        ...
        if kwargs['use_desc']:
            ...
            self.desc_classifier_represent = nn.Linear(self.desc_conv_output_size*2, self.represent_dim[2])
        ...
        if kwargs['use_image']:
            ...
            self.image_classifier_represent = nn.Linear(self.image_classifier_dim, self.represent_dim[3])
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None,
        ...
        if self.use_graph:
            ...
            gnn_represent = self.graph_classifier_represent(self.activation(torch.cat((gnn1_outputs, gnn2_outputs), 1)))
        ...
        if self.use_formula:
            ...
            formula_represent = self.formula_classifier_represent(formula_outputs)
        ...
        # Image
        if self.use_image:
            image_classifier_output1 = self.activation(image_classifier_output1)
